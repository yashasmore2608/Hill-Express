...
import { APP_DEFAULT_THEME, APP_THEME_FORCE } from '../config';
import '../i18n';
import '../global.css';
...
export default function RootLayout() {
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <SafeAreaProvider>
        {/* Opens dark (night riding) but the driver can switch — the choice
            persists on the device. */}
        <ThemeProvider
          force={APP_THEME_FORCE}
          defaultMode={APP_DEFAULT_THEME}
